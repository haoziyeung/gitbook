...
Our approach uses the measurement of allelic prevalence to estimate the proportion of tumour cells harbouring a mutation (referred to herein as the ’cellular prevalence’).
使用等位基因发病率的测量来估计携带突变的肿瘤细胞的比例；
...
### 
```
input="sample1.tsv sample2.tsv sample3.tsv sample4.tsv"

PyClone run_analysis_pipeline \
--in_files $input \
--num_iters 40000 --burnin 20000 \
